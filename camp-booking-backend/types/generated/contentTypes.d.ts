...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    campsites: Schema.Attribute.Relation<'oneToMany', 'api::campsite.campsite'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCampsiteCampsite extends Struct.CollectionTypeSchema {
  collectionName: 'campsites';
  info: {
    displayName: 'Campsite';
    pluralName: 'campsites';
    singularName: 'campsite';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    campsiteId: Schema.Attribute.UID;
    campsiteType: Schema.Attribute.Enumeration<['tent', 'bungalov', 'pitch']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::campsite.campsite': ApiCampsiteCampsite;
